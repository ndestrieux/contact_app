...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        a1 = Address.objects.create(
            city="Los Angeles", street="Mulholland Drive", building_number="666"
        )
        a2 = Address.objects.create(
            city="Twin Peaks",
            street="Horror street",
            building_number="7",
            flat_number="1",
        )
        ...
        a4 = Address.objects.create(
            city="Washington", street="Pennsylvania Avenue", building_number="935"
        )
        a5 = Address.objects.create(
            city="Los Angeles", street="Hollywood Boulevard", building_number="1876c"
        )
        ...
        p1 = Person.objects.create(
            first_name="David", last_name="Lynch", address=a1, phone=ph1, email=em1
        )
        p2 = Person.objects.create(
            first_name="Robert", last_name="Engels", address=a1, phone=ph1, email=em1
        )
        p3 = Person.objects.create(
            first_name="Sheryl", last_name="Lee", address=a2, phone=ph2, email=em2
        )
        p4 = Person.objects.create(
            first_name="Ray", last_name="Wise", address=a3, phone=ph3, email=em3
        )
        ...
        p6 = Person.objects.create(
            first_name="Tim", last_name="Burton", address=a5, phone=ph5, email=em5
        )
